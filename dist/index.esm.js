...
import fs from 'fs';
import { filter, any, find } from 'lodash/fp';
...
var hasSetupNode = any(isSetupNode);
var hasSetupInfo = any(hasSetupNode);

export { cd, crawl, createNode, getContents, getDirs, getFiles, getSetupInfo, hasSetupInfo, hasSetupNode, isSetupNode, ls, noDirs, noDotfiles, noFiles, onlyDirs, onlyExt, onlyFiles, readFile, scan };
