...
declare namespace nw {
  function require<T extends string>(id: T): import(T);
  ...
  class NWApp {
    ...
    addOriginAccessWhitelistEntry(
      ...
      allowDestinationSubdomain: boolean
    ): void;
  ...
  class Shortcut {
    ...
    public key: string;
    constructor(option: { key: string; active?: Function; failed?: Function });
  ...
  class Clipboard {
    ...
    set(clipboardData: Clipboard.ClipboardData): this;
    set(clipboardDataList: Clipboard.ClipboardData[]): this;
    get(type?: string, raw?: boolean): string;
    get(clipboardData: Clipboard.ClipboardData): string;
    get(
      clipboardDataList: Clipboard.ClipboardData[]
  ...
  class NWDesktopCaptureMonitor {
    ...
    on(
      ...
      listener: (
        ...
        name: string,
        order: number,
        type: "screen" | "window" | "other" | "unknown",
        primary: boolean
      ) => void
    ): this;
    ...
    on(
      event: "orderchanged",
      listener: (id: string, new_order: number, old_order: number) => void
    ): this;
    on(
      event: "namechanged",
      listener: (id: string, name: string) => void
    ): this;
    on(
      event: "thumbnailchanged",
      listener: (id: string, thumbnail: string) => void
    ): this;
  }
  ...
  class NWScreen {
    public readonly screens: ScreenData[];
    public readonly DesktopCaptureMonitor: NWDesktopCaptureMonitor;
    constructor();
    Init(): void;
    chooseDesktopMedia(
      sources: "window" | "screen"[],
      callback: (streamId: number | false) => void
    ): this;
    on(
      event: "displayBoundsChanged",
      listener: (screen: ScreenData) => void
    ): this;
    on(event: "displayAdded", listener: (screen: ScreenData) => void): this;
    on(event: "displayRemoved", listener: (screen: ScreenData) => void): this;
  }

  interface WindowSubfields {
    id?: string;
    title?: string;
    width?: number;
    height?: number;
  ...
  interface WindowOptions extends WindowSubfields {
  ...
  class Window {
    ...
    showDevTools(
      iframe?: string | HTMLFrameElement,
    ...
    on(
      ...
      listener: (frame: HTMLFrameElement | null) => void
    ): this;
    on(
      event: "document-end",
      listener: (frame: HTMLFrameElement | null) => void
    ...
    on(
      ...
      listener: (
        ...
        policy: {
          ...
          forceNewWindow(): void;
          forceNewPopup(): void;
          setNewWindowManifest(m: WindowSubfields): void;
        }
      ) => void
    ): this;
    on(
